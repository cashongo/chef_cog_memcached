name              'cog_memcached'
maintainer        'Andreas Wagner'
maintainer_email  'andreas.wagner@cashongo.co.uk'
license           'Apache 2.0'
description       'Installs memcached and provides a define to set up an instance of memcache via runit, forked from official opscode cookbook'
